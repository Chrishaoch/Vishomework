...
// foreground.fillText("Loading...",w/2,h/2);//-Hao
...
var max = 70; 
  ...
  g.append("svg:g")
      ...
      .each(function(d) { d3.select(this).call(axis.scale(yscale[d]).tickFormat(function(d){ if(d>=1) return formatter(d); else return logFormatter(d);} ).tickValues([70])); })   // -Hao
    .append("svg:text")
      .attr("text-anchor", "middle")
      .attr("y", function(d,i) { return i%2 == 0 ? -20 : -35 } )
      .attr("x", 0)
      .attr("class", "label")
      .text(String)
      .append("title")
  ...
  g.append("svg:g")
      .attr("class", "brush")
      //.each(function(d) { d3.select(this).call(yscale[d].brush = d3.svg.brush().y(yscale[d]).on("brush", brush)); }) //-Hao the back ground
    .selectAll("rect")
